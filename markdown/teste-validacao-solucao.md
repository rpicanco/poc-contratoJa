...
1. Importe no <a href="/postman/" rel="some text"><img src="/imagens/icone-postman.png" vertical-align: midle alt="Postman" width="70" height="50" /></a> a coleção **Poc contratoJa.postman_collection.json** e variável de ambiente **Localstack.postman_environment.json** da pasta _postman_ do projeto. 
